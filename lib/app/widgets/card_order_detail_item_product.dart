...
class CardOrderDetailItemProduct extends StatefulWidget {
  const CardOrderDetailItemProduct({
    super.key,
  ...
  @override
  State<CardOrderDetailItemProduct> createState() =>
      _CardOrderDetailItemProductState();
}

class _CardOrderDetailItemProductState
    extends State<CardOrderDetailItemProduct> {
  bool checked = false;
